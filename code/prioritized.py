...
class PrioritizedPlanningSolver(object):
    ...
    def find_solution(self):
        ...
        # # Constraint for Task 1.4
        # constraints = [{"agent":0, "loc":[(1,2),(1,3)], "timestep":2},
        #                 {"agent":0, "loc":[(1,2),(1,3)], "timestep":4},
        #                 {"agent":0, "loc":[(1,2),(1,3)], "timestep":6},
        #                 {"agent":0, "loc":[(1,5)], "timestep":10}]

        # # Constraint for Task 1.5
        ...
        for i in range(self.num_of_agents):  # Find path for each agent
            ...
            # Vertex Constraints and Edge Constraints for Task 2.1 and 2.2 
            for k in range(self.num_of_agents):
                n = len(path)
                
                # Constraint for Task 2.3
                h, _ = len(self.my_map), len(self.my_map[0])
                for m in range(h):
                    constraints.append({"agent":k, "loc":[path[n-1]], "timestep":n+m-1})
